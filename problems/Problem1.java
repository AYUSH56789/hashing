...
public class Problem1 {
    // overall time complexity : O(N+M) = O(N) -> Because N is dominating factor in this code. In the worst case M = N than overall time complexity is O(2N) where 2 is constant we remove it . so the time complexity in worst case is O(N)
